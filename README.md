...
<a href="#ELK-PROMETHEUS-GRAFANA-ZIPKIN-MYSQL">
  <img src="elk_prometheus_grafana_v1/files/media/top.png" alt="" />
</a>
<br>
<br>
...
![environment-diagram.png](elk_prometheus_grafana_v1/files/media/environment-diagram.png)
...
<pre>
elk_prometheus_grafana_v1/prometheus/script/targets-export.sh
</pre>
...
![prometheus-sample.png](elk_prometheus_grafana_v1/files/media/prometheus-sample.png)
...
output {
    elasticsearch {
        ...
        index => "elk_prometheus_grafana_v1_demo"
...
![grafana-dashboards.png](elk_prometheus_grafana_v1/files/media/grafana-dashboards.png)

- Connect Grafana to Prometheus

![grafana-datasources.png](elk_prometheus_grafana_v1/files/media/grafana-datasources.png)
...
![grafana-spring-boot-statistics-dashboard-import.png](elk_prometheus_grafana_v1/files/media/grafana-spring-boot-statistics-dashboard-import.png)
...
- How to execute:
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ ./targets-export.sh /home/user/logs/EUREKA-SERVICE-DISCOVERY.log /home/prometheus/targets/ [--reload: optional]
</pre>
...
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ ./targets-export.sh /home/user/logs/EUREKA-SERVICE-DISCOVERY.log /home/prometheus/targets/
</pre>

2- Export targets to prometheus with reload prometheus (recommended):<br>
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ ./targets-export.sh /home/user/logs/EUREKA-SERVICE-DISCOVERY.log /home/prometheus/targets/ --reload
</pre>
...
- select the index on the left side of the screen and analyze the log
  ![kibana-discover-log-sample.png](elk_prometheus_grafana_v1/files/media/kibana-discover-log-sample.png)
  ![kibana-discover-log-sample.png](elk_prometheus_grafana_v1/files/media/kibana-discover-log-index.png)
...
GET elk_prometheus_grafana_v1_demo/_search
{
  "query": {
    "match": {
...
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ docker exec -it logstash /bin/bash
...
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ docker exec -it logstash sh /home/logstash/logstash-reload.sh 
</pre>
...
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ [Ctrl+C]
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ docker-compose start
</pre>
...
7- Export the microservices targets from EUREKA SERVICE DISCOVERY to Prometheus
...
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ cd prometheus/script/
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ ./targets-export.sh /home/$USER/logs/EUREKA-SERVICE-DISCOVERY.log /home/prometheus/targets/ [--reload: optional]

#Real Example:
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ ./targets-export.sh ~/Documentos/Devel/Docker/docker-series/elk_prometheus_grafana_v1/ec2/app/service-discovery/EUREKA-SERVICE-DISCOVERY.log /home/prometheus/targets/ --reload
</pre>

8- Check and configure logstash
...
![kibana-create-indexes.png](elk_prometheus_grafana_v1/files/media/kibana-create-indexes.png)
...
10.4.1) Prometheus Settings (targets)
...
<pre>
user@host:/home/user/docker-series/elk_prometheus_grafana_v1$ docker exec -it zipkin sh
</pre>
