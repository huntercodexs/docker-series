...
COPY ./extensions/php-8.1.0-compiled-extensions.zip $DIR_PHP_EXTENSIONS/
RUN unzip -o $DIR_PHP_EXTENSIONS/php-8.1.0-compiled-extensions.zip -d $DIR_PHP_EXTENSIONS
