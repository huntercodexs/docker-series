...
user@host:/home/user/docker-series/self-containers/firebird$ docker-compose up --build (in first time)
user@host:/home/user/docker-series/self-containers/firebird$ docker-compose start (in the next times)
</pre>
