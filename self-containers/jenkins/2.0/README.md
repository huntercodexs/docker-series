...
user@host:/home/user/docker-series/self-containers/jenkins/2.0$ docker-compose up --build (in first time)
user@host:/home/user/docker-series/self-containers/jenkins/2.0$ docker-compose start (in the next times)
</pre>
